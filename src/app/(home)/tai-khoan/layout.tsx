...
export default function AccountLayout({
  ...
  return (
    <div
      className="mx-auto h-full w-full max-w-7xl 2xl:max-w-[1520px] px-4 sm:px-6 lg:px-8 xl:px-16 2xl:px-20"
    >
      <div className="grid grid-cols-1 md:grid-cols-10 gap-2 pt-3">
